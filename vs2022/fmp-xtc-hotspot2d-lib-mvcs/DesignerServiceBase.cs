...
namespace XTC.FMP.MOD.Hotspot2D.LIB.MVCS
{
    ...
    public class DesignerServiceBase : Service
    {
        ...
        public async Task<Error> CallReadStyleSheet(ScopeRequest? _request)
        {
            ...
            var response = await client.ReadStyleSheetAsync(_request);
            getModel()?.UpdateProtoReadStyleSheet(response);
            return Error.OK;
        }
        ...
        public async Task<Error> CallWriteStyle(DesignerWriteStylesRequest? _request)
        {
            ...
            var response = await client.WriteStyleAsync(_request);
            getModel()?.UpdateProtoWriteStyle(response);
            return Error.OK;
        }
        ...
        public async Task<Error> CallReadInstances(ScopeRequest? _request)
        {
            ...
            var response = await client.ReadInstancesAsync(_request);
            getModel()?.UpdateProtoReadInstances(response);
            return Error.OK;
        }
        ...
        public async Task<Error> CallWriteInstances(DesignerWriteInstancesRequest? _request)
        {
            ...
            var response = await client.WriteInstancesAsync(_request);
            getModel()?.UpdateProtoWriteInstances(response);
            return Error.OK;
        }
